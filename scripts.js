function computeLoan() {
  ...
  document.querySelector("#loan_show").innerHTML = `Loan Amount = $${amount}`;
  document.querySelector(
    "#interest_show"
  ).innerHTML = `Interest Rate = ${interest_rate}`;
  document.querySelector("#months_show").innerHTML = `Months = ${months}`;
}
